...
class DistributionCenter():
    ...
    def __init__(self,max_length_storage, min_length_storage, max_elements_storage,  max_len_buffer,
                max_width_buffer, max_elements_buffer, max_len_DC, max_width_DC, min_width_isle):
        self.max_length_DC = max_len_DC
